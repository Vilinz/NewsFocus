...
public class BigImageActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        curImageUrl = intent.getStringExtra("imageUrl");
        ...
        mPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                if (imageUrls.get(position) != null && !"".equals(imageUrls.get(position))) {
                    final PhotoView view = new PhotoView(BigImageActivity.this);
                    view.enable();
                    view.setScaleType(ImageView.ScaleType.FIT_CENTER);
                    Glide.with(BigImageActivity.this).load(imageUrls.get(position)).override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL).fitCenter().crossFade().listener(new RequestListener<String, GlideDrawable>() {
                        @Override
    ...
    private void showLoadingAnimation() {
        ...
        centerIv.setImageResource(R.drawable.ic_action_name);
            ...
            FileUtils.savePhoto(this, bitmap, new FileUtils.SaveResultCallback() {
                ...
                public void onSavedFailed() {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(BigImageActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
